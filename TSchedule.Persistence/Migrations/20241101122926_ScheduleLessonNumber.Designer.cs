...
namespace TSchedule.Persistence.Migrations
{
    ...
    [Migration("20241101122926_ScheduleLessonNumber")]
    partial class ScheduleLessonNumber
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TSchedule.Persistence.Entities.Schedule", b =>
                {
                    ...
                    b.HasIndex(new[] { "DayOfWeek", "StartTime", "ClassroomId" }, "IX_Schedule_Classroom_Time")
                        .IsUnique();

                    b.HasIndex(new[] { "DayOfWeek", "StartTime", "TeacherId" }, "IX_Schedule_Teacher_Time")
                        .IsUnique();
